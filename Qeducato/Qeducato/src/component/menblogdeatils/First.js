...
import bDetails01 from "../../assets/img/blog/b_details01.jpg";
import bDetails02 from "../../assets/img/blog/b_details02.jpg";
import bDetails03 from "../../assets/img/blog/b_details03.jpg";
import bDetails04 from "../../assets/img/blog/b_details04.jpg";
                  ...
                  <div className="row align-items-center">
                    <div className="col-xl-4 col-md-5">
                      <div className="prev-link">
                        <span>Prev Post</span>
                        <h4>
                          <a href="#">Choosing Your Vocational Path</a>
                        </h4>
                      </div>
                    </div>
                    ...
                    <div className="col-xl-4 col-md-5">
                      <div className="next-link text-left text-md-right">
                        <span>next Post</span>
                        <h4>
                          <a href="#">Career Growth in Vocational Fields</a>
                        </h4>
                      </div>
                    </div>
                  </div>
                ...
                <div className="comment__wrap pb-45">
                  ...
                  <div className="single__comment mb-35">
                    <div className="comments-avatar">
                      <img src={c01} alt="" style={{ borderRadius: "12px" }} />
                    </div>
                  ...
                  <div className="single__comment children mb-35">
                    <div className="comments-avatar">
                      <img src={c02} alt="" style={{ borderRadius: "12px" }} />
                    </div>
                    <div className="comment-text">
                      <div className="avatar-name mb-15">
                        <h6>
                  ...
                  <div className="single__comment">
                    <div className="comments-avatar">
                      <img src={c03} alt="" style={{ borderRadius: "12px" }} />
                    </div>
                    <div className="comment-text">
                      <div className="avatar-name mb-15">
                        <h6>Arjun Patel</h6>
