                ...
                <section id="categories-1" className="widget widget_categories">
                  ...
                  <ul>
                    <li className="cat-item cat-item-1">
                      <Link to="#">Logistics & Shipping Management</Link>
                    </li>
                    <li className="cat-item cat-item-2">
                      <Link to="#">Automotive Technology</Link>
                    </li>
                    <li className="cat-item cat-item-3">
                      <Link to="#">HR & Office Administration</Link>
                    </li>
                    <li className="cat-item cat-item-4">
                      <Link to="#">Hospital Administration</Link>
                    </li>
                    <li className="cat-item cat-item-5">
                      <Link to="#">Global Business Management</Link>
                    </li>
                  </ul>
                </section>
                <section
