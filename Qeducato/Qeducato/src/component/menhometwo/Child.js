...
function Child() {
  return (
    <>
      <section
        className="cta-area cta-bg pt-30 pb-30"
        style={{ background: "#4899d2" }}
      >
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              >
                ...
                <p>
                  At Estuidar University, we prepare you to launch your career
                  by providing a supportive, creative, and professional
                  environment from which to learn practical skills and build a
