...
function Aboutvideo() {
  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-12">
              <div
                ...
                style={{ backgroundImage: "url(assets/img/bg/video-img.png)" }}
              >
      ...
      <div className="counter-area pb-90" style={{ background: "#4899d2" }}>
        <div className="container">
          <div className="row p-relative">
            <div className="col-lg-3 col-md-6 col-sm-12">
              ...
              >
                <div
                  className="counter p-relative"
                  style={{
                    backgroundImage: "url(assets/img/bg/c-object.png)",
            ...
            <div className="col-lg-3 col-md-6 col-sm-12">
              ...
              >
                ...
                >
                  <CountUp className="count" start={12} end={1879}>
                    {" "}
                  </CountUp>
                  <p>
                    {" "}
            ...
            <div className="col-lg-3 col-md-6 col-sm-12">
              ...
              >
                ...
                >
                  <CountUp className="count" start={15} end={2547}>
                    {" "}
                  </CountUp>
                  <p>
                    {" "}
